...
if (isset($_POST['simpankomentar'])) {
  ...
  if ($insert_komentar) {
      header('location: car.php?msg=komentar');
  }
}
...
if (isset($_POST['simpankomentarbalasan'])) {
  ...
  if ($insert_komentarbalasan) {
      header('location: car.php?msg=balasan');
  }
}
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 offset-md-3 text-center mt-3">
        <div class="card">
          <img src="assets\carr.jpg" class="card-img-top card-img-bottom" width="100%" style="height:340px">
