        ...
        <div class="modal-content">
          <div class="modal-header">
            <div id="profile-frame">
              ...
              <input type="file" id="file-input" accept="image/*" name="profile_picture">
              <?php
                  if(isset($_POST['save-changes'])){
                    if (isset($_POST['profile_picture'])) {
                      $targetDirectory = "proyekTekweb/images";
                      ...
                      if (move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $targetFile)) {
                          ...
                          // Get the user ID from the session or database (replace with your actual logic)
                          $userEmail = $_SESSION['email']; // Assuming you have a user_id in your session
                  
                          // Update the user's profile URL in the database
                          $updateQuery = "UPDATE user SET profileURL = '$profileURL' WHERE email = '$userEmail'";
                          // Execute the update query (replace with your database connection code)
                          // Example using mysqli (replace with your preferred database library)
...
<script>
    document.getElementById('profile-frame').addEventListener('click', function() {
